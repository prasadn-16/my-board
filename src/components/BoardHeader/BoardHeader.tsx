...
const BoardHeader = ({ boardId, title }: BoardHeaderProps) => {
  ...
  return (
    <>
      {isEditing ? (
        // Added w-full to ensure the container doesn't overflow
        <div className="flex gap-2 mb-2 w-full">
          <input
            ...
            // Added min-w-0 to allow the input to shrink on small mobile screens
          ...
          <button
            ...
            // Added shrink-0 so the save button keeps its shape
        ...
        <div className="flex justify-between items-center mb-2 group">
          <div
            ...
            className="text-lg font-semibold flex-1 cursor-pointer hover:text-indigo-600 transition-colors break-words min-w-0 pr-2"
          >
            {title}
          </div>
